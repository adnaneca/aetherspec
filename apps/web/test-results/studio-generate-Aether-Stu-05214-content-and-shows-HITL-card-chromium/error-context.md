...
- Name: studio-generate.spec.ts >> Aether Studio generation flow >> Clicking Generate Section streams content and shows HITL card
- Location: e2e/studio-generate.spec.ts:55:3
