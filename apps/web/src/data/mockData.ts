...
export const MOCK_PROJECTS: SDLCProject[] = [
  {
    ...
    key: "FLEET",
    description:
      "AI-driven real-time vehicle telematics tracking, driver scoring, and automated maintenance scheduling system.",
  ...
  },
  {
    ...
    key: "PAYMENT",
    description:
      "KVKK compliant PCI-DSS billing engine with automated credit risk checks and multi-bank integration.",
