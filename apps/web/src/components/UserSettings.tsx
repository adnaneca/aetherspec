          ...
          <div>
            ...
            <div className="flex items-center gap-1.5 mt-1">
              ...
              <span className="font-mono text-[10px] text-muted-foreground">
                {t("userSettings.keycloakScope")}:{" "}
                {activePersona.keycloakRoles.join(" · ")}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
        ...
        <div className="p-5 rounded-xl border border-border bg-card space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <label className="block text-foreground font-medium mb-1 mt-3">
                AetherSpec Theme
              </label>
        ...
        <div className="p-5 rounded-xl border border-border bg-card space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div>
              <label className="block text-foreground font-medium mb-1">
                {t("userSettings.reviewPolicy")}
              </label>
              <select
                value={settings.artifactReviewMode}
                onChange={(e) =>
                  updateSettings({ artifactReviewMode: e.target.value as any })
                }
              ...
              >
                <option value="always-ask">
                  {t("userSettings.alwaysAsk")}
                </option>
                <option value="agent-decides">
                  {t("userSettings.agentDecides")}
                </option>
                <option value="auto-proceed">
                  {t("userSettings.autoProceed")}
                </option>
              </select>
            </div>
